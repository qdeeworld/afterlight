/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e9662af1a3865cf6d4ad9080c07c6e7a)
// Runtime types generated with workerd@1.20260828.1 2026-08-28 nodejs_compat
interface __BaseEnv_Env {
	RELAY_RATE_LIMITER: RateLimit;
	RELAY_GLOBAL_LIMITER: RateLimit;
	CHECKPOINT_RATE_LIMITER: RateLimit;
	EXIT_RATE_LIMITER: RateLimit;
	DEPLOYMENT_STAGE: "phase-b-live-spike";
	ALLOWED_ORIGIN: "https://afterlight-app.pages.dev,https://afterlight.dolepee.com";
	AFTERLIGHT_CONTRACT: "0x06e8b6e49b4366e0dc6a35eee722b417c718988eca3f4a0c298bdf8785261c25";
	STARKNET_CHAIN_ID: "0x534e5f4d41494e";
	STRK_TOKEN: "0x04718f5a0fc34cc1af16a1cdee98ffb20c31f5cd61d6ab07201858f4287c938d";
	RESERVE_AMOUNT_FRI: "1000000000000000000";
	MAX_RELAY_TTL_SECONDS: "900";
	MAX_RELAY_PAYLOAD_BYTES: "2048";
	MAX_EXIT_PAYLOAD_BYTES: "2097152";
	FIRST_USE_SETUP_ENABLED: "true";
	MAX_OUTSTANDING_VAULTS: "3";
	DAILY_EXIT_BUDGET_FRI: "22500000000000000000";
	FUNDING_ADMISSION_TTL_MS: "600000";
	MAX_SPONSORED_FEE_FRI: "400000000000000000";
	DAILY_SPONSOR_BUDGET_FRI: "1600000000000000000";
	SPONSOR_FEE_MARGIN_BPS: "11000";
	MIN_RELAYER_BALANCE_FRI: "1000000000000000000";
	DEPLOYMENT_ID: "afterlight-mainnet-e3-20260829-v6";
	RELAYER_ACCOUNT_ADDRESS: "0x05b0b8cbda8eca89b88ae6975c80a880b0164a853c6ed881a56e39e4622edd46";
	RELAYER_ACCOUNT_CAIRO_VERSION: "1";
	STARKNET_RPC_URL: "https://api.cartridge.gg/x/starknet/mainnet/rpc/v0_10";
	SUBMIT_ENABLED: "true";
	RELAYER_ACCOUNT_PRIVATE_KEY: string;
	STARKNET_RPC_AUTH_TOKEN: string;
	EXIT_RPC_URL: string;
	RELAY_BUDGET: DurableObjectNamespace<import("./src/index").RelayBudget>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RelayBudget";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEPLOYMENT_STAGE" | "ALLOWED_ORIGIN" | "AFTERLIGHT_CONTRACT" | "STARKNET_CHAIN_ID" | "STRK_TOKEN" | "RESERVE_AMOUNT_FRI" | "MAX_RELAY_TTL_SECONDS" | "MAX_RELAY_PAYLOAD_BYTES" | "MAX_EXIT_PAYLOAD_BYTES" | "FIRST_USE_SETUP_ENABLED" | "MAX_OUTSTANDING_VAULTS" | "DAILY_EXIT_BUDGET_FRI" | "FUNDING_ADMISSION_TTL_MS" | "MAX_SPONSORED_FEE_FRI" | "DAILY_SPONSOR_BUDGET_FRI" | "SPONSOR_FEE_MARGIN_BPS" | "MIN_RELAYER_BALANCE_FRI" | "DEPLOYMENT_ID" | "RELAYER_ACCOUNT_ADDRESS" | "RELAYER_ACCOUNT_CAIRO_VERSION" | "STARKNET_RPC_URL" | "SUBMIT_ENABLED" | "RELAYER_ACCOUNT_PRIVATE_KEY" | "STARKNET_RPC_AUTH_TOKEN" | "EXIT_RPC_URL">> {}
}
